...
?>
	...
	<div id="new-detail">
	<button type="button" id="addDetail" class="button-secondary" tabindex="8"><small><?php _e('Add Product Detail','Ecart'); ?></small></button>
	<p><?php _e('Build a list of detailed information such as dimensions or features of the product.','Ecart'); ?></p>
	</div>
...
add_meta_box(
	'product-details-box',
	__('Details &amp; Specs','Ecart').$Admin->boxhelp('product-editor-details'),
	'details_meta_box',
	'ecart_page_ecart-products',
	'normal',
	'core'
