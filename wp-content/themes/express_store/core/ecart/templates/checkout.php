...
<?php if (ecart('cart','hasitems')): ?>
	...
	<ul id="customer-form">
		...
		<?php endif; ?>
		<li class="<?php if (ecart('customer','notloggedin')) { echo 'half right'; } ?> reg-input">
		...
		<?php if (ecart('customer','notloggedin')): ?>
		<li class="half reg-input" id="fixed-inputs">
		...
		<div class="inline"><?php ecart('checkout','same-shipping-address'); ?></div>
		<?php else: ?>
			</li>
		<?php endif; ?>
