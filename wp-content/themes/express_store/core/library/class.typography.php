...
/*-----------------------------------------------------------------------------------*/
/* Options Framework Typography Builder Add new fonts here....
/*-----------------------------------------------------------------------------------*/

class EPANEL_WPFoundry {
	...
	// otherwise get font stack
	
	function get_stack($font_id){
		return $this->foundry[$font_id]['family'];
	}
	
	//used for dynamic css - not for production
