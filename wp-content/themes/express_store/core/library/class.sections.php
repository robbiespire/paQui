...
/*-----------------------------------------------------------------------------------*/
/* Options Framework Components Sections Handler
/*-----------------------------------------------------------------------------------*/

class EPANEL_WPSection {
	...
	function section_template() {
		die('function EPANEL_WPSection::section_template() must be over-ridden in a sub-class.');
	}
	...
	function before_section( $markup = 'content' ){
		...
		do_action('epanel_before_'.$this->id);
		if( $set_markup == 'copy' ):?>
...
<?php 	endif;
		...
		do_action('epanel_inside_top_'.$this->id);
 	}
	...
	function after_section( $markup = 'content' ){
		...
		do_action('epanel_inside_bottom_'.$this->id);
...
<?php 	endif;
		...
		do_action('epanel_after_'.$this->id);
	}
...
/*-----------------------------------------------------------------------------------*/
/* Load sections from folder
/*-----------------------------------------------------------------------------------*/

function epanel_register_section($section_class, $section_folder, $init_file = null, $args = array()){
...
/*-----------------------------------------------------------------------------------*/
/* Dont' know what to say... we know what this is...
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Load the admin framework for new included sections
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Save new framework options if needed
/*-----------------------------------------------------------------------------------*/
